...
fn recent_project_review_falls_back_cleanly_when_no_repo_is_known() {
    ...
    // "active", not "recent": e90512dd6 deliberately reworded this notice and
    // missed the assertion, so the test has been failing ever since on any
    // machine whose home directory is not itself a Git repository.
